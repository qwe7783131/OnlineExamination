...
<head>
	...
	<body style="background-color:#f2f9fd;">
		...
		<div class="leftnav">
		    ...
		    <ul>
		    	<li><a href="add.jsp" target="right"><span class="icon-caret-right"></span>添加试题</a></li>
		    	<li><a href="manageQuestions.jsp" target="right"><span class="icon-caret-right"></span>管理试题</a></li>
		   </ul>
		   <h2><span class="icon-pencil-square-o"></span>公告管理</h2>
		    <ul>
		    	<li><a href="info.jsp" target="right"><span class="icon-caret-right"></span>添加公告</a></li>
		    	<li><a href="manageInfo.jsp" target="right"><span class="icon-caret-right"></span>管理公告</a></li>
		   </ul>
		   <h2><span class="icon-pencil-square-o"></span>信息管理</h2>
		    <ul>
		    	<li><a href="list.jsp" target="right"><span class="icon-caret-right"></span>查询成绩</a></li>
		   </ul>
		</div>

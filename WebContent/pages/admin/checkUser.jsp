...
<html lang="zh-cn">
	...
	<body>
		<div class="panel admin-panel">
			<div class="panel-head"><strong class="icon-reorder"> 审核用户信息</strong></div>
							...
							<tr>
								...
								<td>
									<div class="button-group">
										<a class="button border-main" href="javascript:void(0)" onclick=""> 通&nbsp;&nbsp;&nbsp;过</a>
										<a class="button border-red" href="javascript:void(0)" onclick=""> 不通过</a>
									</div>
								</td>
							</tr>
